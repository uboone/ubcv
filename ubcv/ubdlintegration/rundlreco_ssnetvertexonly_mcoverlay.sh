...
# -----------------------
LARLITE_FILE_LIST="larlite_dlmerged.root larlite_opreco.root larlite_reco2d.root larlite_mcinfo.root tagger_anaout_larlite.root tracker_reco.root nueid_ll_out_0.root larlite_ssnetshowerreco.root"
...
echo "<<< make inter file for MPID use >>>"
...
rm -f shower_reco_out_0.root nueid_lcv_out_0.root nueid_ll_out_0.root lcv_trash.root nueid_ana_0.root larlite_ssnetshowerreco.root
