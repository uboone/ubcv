...
hadd -f merged_dlreco.root $VERTEXOUT $VERTEXANA larlite_dlmerged.root #$TRKONLY_VERTEXOUT $VERTEXANA $TRKONLY_VERTEXANA $TRACKERANA $TRKONLY_TRACKERANA larlite_dlmerged.root
